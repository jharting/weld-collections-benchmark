...
public class DefaultComputingCacheBenchmark extends AbstractCacheBenchmark<ComputingCache<Foo, Foo>> {
    ...
    @Override
    protected Foo getValue(ComputingCache<Foo, Foo> cache, Foo key) {
